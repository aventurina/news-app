...
**Live site:** [news-app-0h3u.onrender.com](https://news-app-0h3u.onrender.com/)
...
**Why no framework:** this was a chance to build the interaction logic (debouncing, request cancellation, pagination state) by hand instead of leaning on a framework to manage it, so the fundamentals underneath a framework are things I've actually built, not just used.
